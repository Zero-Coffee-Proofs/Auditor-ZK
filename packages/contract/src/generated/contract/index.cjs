...
const _descriptor_9 = new _ProofOfReserves_0();

const _descriptor_10 = new __compactRuntime.CompactTypeBytes(64);
...
class _TokenInfo_0 {
  ...
  fromValue(value_0) {
    return {
      name: _descriptor_10.fromValue(value_0),
      totalSupply: _descriptor_5.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_10.toValue(value_0.name).concat(_descriptor_5.toValue(value_0.totalSupply));
  }
}

const _descriptor_11 = new _TokenInfo_0();
...
const _descriptor_14 = new _QualifiedCoinInfo_0();
...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      submitProof: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('submitProof',
                                      ...
                                      'provedToken.compact line 115 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
      ...
      mint: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('mint',
                                      'argument 1 (as invoked from Typescript)',
                                      'provedToken.compact line 151 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
      ...
      transfer: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('transfer',
                                      'argument 1 (as invoked from Typescript)',
                                      'provedToken.compact line 210 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
      ...
      buy: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('buy',
                                      'argument 1 (as invoked from Typescript)',
                                      'provedToken.compact line 254 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(amountToBuy_0).concat(_descriptor_8.toValue(payment_0)),
      ...
      owner: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('owner',
                                      'argument 1 (as invoked from Typescript)',
                                      'provedToken.compact line 369 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        const context = { ...contextOrig_0 };
      ...
      debugCommitment(context, ...args_1) {
        return { result: pureCircuits.debugCommitment(...args_1), context };
      }
    };
    this.impureCircuits = {
  ...
  initialState(...args_0) {
    ...
    const _pricePerToken_0 = args_0[2];
    ...
    if (!(_tokenName_0.buffer instanceof ArrayBuffer && _tokenName_0.BYTES_PER_ELEMENT === 1 && _tokenName_0.length === 64)) {
      __compactRuntime.type_error('Contract state constructor',
                                  'argument 1 (argument 2 as invoked from Typescript)',
                                  'provedToken.compact line 74 char 1',
                                  'Bytes<64>',
                                  _tokenName_0)
    }
                    ...
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_15.toValue(2n),
                                                                            alignment: _descriptor_15.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue({ name: new Uint8Array(64), totalSupply: 0n }),
                    ...
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_15.toValue(3n),
                                                                            alignment: _descriptor_15.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue({ commitment: new Uint8Array(32), timestamp: 0n, threshold: 0n }),
  ...
  _mint_0(context, partialProofData, balance_0, blinder_0, amountToMint_0) {
    __compactRuntime.assert(this._equal_3(_descriptor_6.fromValue(Contract._query(context,
                                                                                  partialProofData,
                                                                                  [
                                                                                   { dup: { n: 0 } },
                                                                                   { idx: { cached: false,
    ...
    const balanceValue_0 = __compactRuntime.convertFieldToBytes(32,
                                                                balance_0,
                                                                'provedToken.compact line 162 char 24');
  ...
  _transfer_0(context, partialProofData, toNullifier_0, amount_0) {
    ...
    const newRecipientBalance_0 = ((t1) => {
                                    if (t1 > 18446744073709551615n) {
                                      throw new __compactRuntime.CompactError('provedToken.compact line 233 char 31: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                                    }
                                    return t1;
  ...
  _buy_0(context, partialProofData, amountToBuy_0, payment_0) {
    __compactRuntime.assert(this._equal_5(_descriptor_6.fromValue(Contract._query(context,
                                                                                  partialProofData,
                                                                                  [
                                                                                   { dup: { n: 0 } },
                                                                                   { idx: { cached: false,
                         ...
                         *
                         _descriptor_5.fromValue(Contract._query(context,
                                                                 ...
                                                                 [
                                                                  ...
                                                                  { popeq: { cached: false,
                                                                             result: undefined } }]).value);
    __compactRuntime.assert(disclosedPayment_0.value >= totalPrice_0,
    ...
    const newBuyerBalance_0 = ((t1) => {
                                if (t1 > 18446744073709551615n) {
                                  throw new __compactRuntime.CompactError('provedToken.compact line 284 char 27: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                                }
                                return t1;
  ...
  _debugCommitment_0(balance_0, blinder_0) {
    const balanceValue_0 = __compactRuntime.convertFieldToBytes(32,
                                                                balance_0,
                                                                'provedToken.compact line 389 char 24');
    const computedCommitment_0 = this._persistentHash_1([balanceValue_0,
                                                         blinder_0]);
    return computedCommitment_0;
  }
  _equal_0(x0, y0) {
    {
      let x1 = x0.bytes;
...
const pureCircuits = {
  publicKey: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.type_error('publicKey',
                                  'argument 1',
                                  'provedToken.compact line 351 char 1',
                                  'Bytes<32>',
                                  sk_0)
    }
  ...
  nullify: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.type_error('nullify',
                                  'argument 1',
                                  'provedToken.compact line 365 char 1',
                                  'Bytes<32>',
                                  sk_0)
    }
  ...
  debugCommitment: (...args_0) => {
    if (args_0.length !== 2) {
      throw new __compactRuntime.CompactError(`debugCommitment: expected 2 arguments (as invoked from Typescript), received ${args_0.length}`);
    }
    const balance_0 = args_0[0];
    const blinder_0 = args_0[1];
    if (!(typeof(balance_0) === 'bigint' && balance_0 >= 0n && balance_0 <= 18446744073709551615n)) {
      __compactRuntime.type_error('debugCommitment',
                                  'argument 1',
                                  'provedToken.compact line 384 char 1',
                                  'Uint<0..18446744073709551615>',
                                  balance_0)
    }
    if (!(blinder_0.buffer instanceof ArrayBuffer && blinder_0.BYTES_PER_ELEMENT === 1 && blinder_0.length === 32)) {
    ...
    return _dummyContract._debugCommitment_0(balance_0, blinder_0);
  }
};
